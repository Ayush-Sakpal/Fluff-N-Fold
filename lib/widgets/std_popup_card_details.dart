...
class StdWashPopupCardDetails extends StatefulWidget{
  StdWashPopupCardDetails({super.key,});

  @override
  State<StdWashPopupCardDetails> createState() => _StdWashPopupCardDetailsState();
}

class _StdWashPopupCardDetailsState extends State<StdWashPopupCardDetails> {
  ...
  Widget build(BuildContext context) {
    return Consumer<StandardWashProvider>(
