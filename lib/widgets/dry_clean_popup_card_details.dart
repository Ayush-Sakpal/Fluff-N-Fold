...
import '../providers/dryCleanProvider.dart';
import 'package:provider/provider.dart';

class DryCleanPopupCardDetails extends StatefulWidget{
  DryCleanPopupCardDetails({super.key,});

  @override
  State<DryCleanPopupCardDetails> createState() => _DryCleanPopupCardDetailsState();
}

class _DryCleanPopupCardDetailsState extends State<DryCleanPopupCardDetails> {
