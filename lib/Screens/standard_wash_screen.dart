...
import '../widgets/std_popup_card_details.dart';
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  padding:
                                      const EdgeInsets.only(right: 16, top: 5),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          ElevatedButton(
                              onPressed: () {
                                if (listProviderModel.getStdCartTotal() != 0) {
                                  _navigationService.pushNamed('/cart');
                                } else {
