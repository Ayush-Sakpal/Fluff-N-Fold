...
import '../widgets/iron_popup_card_details.dart';
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '\u{20B9}' + listProviderModel.getIronCartTotal().toStringAsFixed(2),
                          style: const TextStyle(
                    ...
                    ElevatedButton(
                        onPressed: () {
                          if (listProviderModel.getIronCartTotal() != 0) {
